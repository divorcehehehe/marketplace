...
class MapperReadTest {
    ...
    fun fromTransport() {
        ...
        assertEquals("READ",     context.command.name)
    ...
    fun toTransport() {
        ...
        val request = context.toTransportModel() as ModelReadResponse

        assertEquals("read",             request.responseType)
